...
| [05-agendamento.md](05-agendamento.md) | Task Scheduler - execucao automatica diaria. |
| [TUTORIAL-IMPLANTACAO.md](TUTORIAL-IMPLANTACAO.md) | Supabase, Vercel, Railway ou pipeline local (`.bat` nesta pasta). |
| [MIGRAR-PRODUCAO.md](MIGRAR-PRODUCAO.md) | Migrar contas para producao e agendar os `.bat`. |
| [06-epicos-gitlab.md](06-epicos-gitlab.md) | Épicos no GitLab (Parent vs API legada) e resolução de `issues.epico`. |
